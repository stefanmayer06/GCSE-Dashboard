...
const styles = StyleSheet.create({ content:{padding:20,paddingBottom:108,gap:18},intro: { fontSize: 16, lineHeight: 23 }, docket: { borderWidth: 1, borderLeftWidth: 6, padding: 18, gap: 9,borderRadius:14,shadowColor:'#000',shadowOpacity:.07,shadowRadius:12,shadowOffset:{width:0,height:5},elevation:2 }, code: { fontFamily: 'DMSans', fontSize: 11, fontWeight: '800', letterSpacing: 1 }, title: { fontSize: 23, fontWeight: '800',letterSpacing:-.4 }, actions: { gap: 8, marginTop: 6 }, mixed:{borderWidth:1,borderRadius:14,padding:16,gap:13},chips: { gap: 8 },topicGroup:{gap:8}, chip: { minHeight: 58, padding: 14, borderWidth: 1, gap: 3,borderRadius:15 }, prep: { borderWidth: 2, padding: 18, gap: 12,borderRadius:14,marginTop:8 } });
