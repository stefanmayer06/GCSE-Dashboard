...
const styles = StyleSheet.create({ screen: { flex: 1 }, top: { paddingHorizontal: 18 }, subjectRow: { minHeight: 58, flexDirection: 'row', alignItems: 'center', gap: 10 }, subjectMark: { width: 5, height: 34 }, flex: { flex: 1 }, subject: { fontFamily: 'Fraunces', fontSize: 18, fontWeight: '700' }, caption: { fontSize: 12, marginTop: 2 }, clear: { fontFamily: 'DMSans', fontWeight: '800', fontSize: 12 }, transcript: { padding: 18, paddingBottom: 28, gap: 14 }, context: { borderWidth: 1, borderLeftWidth: 5, padding: 13, gap: 6 }, label: { fontFamily: 'DMSans', fontWeight: '800', fontSize: 10, letterSpacing: .8 }, note: { fontSize: 12, fontStyle: 'italic' }, message: { maxWidth: '88%', borderWidth: 1, padding: 14, gap: 7 }, learner: { alignSelf: 'flex-end', borderTopRightRadius: 2, borderRadius: 14 }, tutor: { alignSelf: 'flex-start', borderTopLeftRadius: 2, borderRadius: 14 }, messageText: { fontSize: 16, lineHeight: 23 }, model: { fontFamily: 'DMSans', fontSize: 10 }, pending: { color: '#fff', fontSize: 11, fontWeight: '700' }, retry: { fontFamily: 'DMSans', fontSize: 11, fontWeight: '900' }, thinking: { flexDirection: 'row', alignItems: 'center', gap: 10, minHeight: 44 }, chips: { gap: 8, paddingTop: 8 }, chip: { minHeight: 44, borderWidth: 1, paddingHorizontal: 14, justifyContent: 'center' }, starters: { gap: 8, paddingTop: 8 }, starter: { minHeight: 48, borderWidth: 1, padding: 12, justifyContent: 'center' }, disclaimer: { fontSize: 11, lineHeight: 16 }, composer: { borderTopWidth: 1, padding: 12, flexDirection: 'row', alignItems: 'flex-end', gap: 10 }, input: { flex: 1, minHeight: 48, maxHeight: 120, borderWidth: 1, paddingHorizontal: 12, paddingVertical: 11, fontSize: 16 }, send: { gap: 4, alignItems: 'flex-end' }, count: { fontSize: 9 }, offlineRoutes: { borderWidth: 1, padding: 13, gap: 4 }, routeTitle: { fontWeight: '700', marginBottom: 3 }, routeLink: { minHeight: 44, justifyContent: 'center' } });
