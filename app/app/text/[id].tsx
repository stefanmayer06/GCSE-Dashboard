...
const styles = StyleSheet.create({content:{padding:20,paddingBottom:60,gap:18},tablet:{width:'100%',maxWidth:860,alignSelf:'center',paddingHorizontal:40},back:{fontFamily:'DMSans',fontWeight:'800',fontSize:11,letterSpacing:1},cache:{fontSize:13},metadata:{gap:5},meta:{fontFamily:'DMSans',fontSize:11,fontWeight:'800',letterSpacing:.9},metaCopy:{fontSize:16,fontWeight:'700'},sourceRole:{fontSize:14,lineHeight:20},tabs:{flexDirection:'row',borderWidth:1,padding:4,gap:4},tab:{flex:1,minHeight:58,padding:9,justifyContent:'center',gap:3},tabText:{fontFamily:'DMSans',fontSize:10,fontWeight:'800'},tabTitle:{fontSize:12},readerTools:{flexDirection:'row',alignItems:'center',justifyContent:'space-between',gap:10,flexWrap:'wrap'},sizeButtons:{flexDirection:'row',alignItems:'center',gap:8},sizeLabel:{minWidth:64,textAlign:'center',fontSize:13},sheet:{borderWidth:1,padding:widthPadding(),gap:15},sourceTitle:{fontFamily:'Fraunces',fontSize:28,lineHeight:35},byline:{fontFamily:'Fraunces',fontStyle:'italic',fontSize:15,borderBottomWidth:StyleSheet.hairlineWidth,paddingBottom:14},body:{fontFamily:'Fraunces'},});
