...
function parsePreferences(value: unknown): PlanningPreferences {
  if (!value || typeof value !== 'object' || Array.isArray(value)) return defaultPlanningPreferences;
