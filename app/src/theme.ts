...
export const subjectTokens = {
  maths: { accent: "#625187", tint: "#eeebf5", label: "Maths Foundation" },
  "maths-higher": { accent: "#176557", tint: "#e0eee7", label: "Maths Higher" },
  english: { accent: "#9b4936", tint: "#f6e9e1", label: "English Language" },
} as const;
const darkSubjects = {
  maths: { ...subjectTokens.maths, accent: "#cfbfea", tint: "#3b3452" },
  "maths-higher": {
    ...subjectTokens["maths-higher"],
    accent: "#92d9bb",
    tint: "#254c40",
  },
  english: { ...subjectTokens.english, accent: "#f1b9a4", tint: "#513c34" },
};
...
export function useTheme() {
  ...
  return {
    ...
    subject: isDark ? darkSubjects[subject] : subjectTokens[subject],
    isDark,
  };
}
